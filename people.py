...
def get_frame(window):
    ...
    people_table.heading("name", text="Patient's Name")
...
def view_person(item, people_table, direct=False):
    ...
    trans_table.heading("type", text="Payment Type")
    trans_table.heading("dot", text="Date Of Transaction")
    trans_table.heading("des", text="Status")
    index = 0
...
def add_person(people_table, edit_person=None):
    ...
    name = Label(top_frame, text="Patient's Name")
